...
badd +1 ~\Desktop\SOL1_MiniComputer\modelsim\compile
badd +0 ~\Desktop\SOL1_MiniComputer\modelsim\systemverilog\ide.sv
argglobal
%argdel
set stal=2
...
silent! normal! zE
let &fdl = &fdl
let s:l = 100 - ((20 * winheight(0) + 24) / 49)
...
normal! 0
tabnext
edit ~\Desktop\SOL1_MiniComputer\modelsim\systemverilog\ide.sv
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 271 - ((24 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 271
...
silent! normal! zE
let &fdl = &fdl
let s:l = 57 - ((22 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 57
