...
silent only
silent tabonly
cd ~\Desktop\SOL1_MiniComputer\systemverilog\ide
...
badd +0 ~\Desktop\SOL1_MiniComputer\systemverilog\ide\ide.sv
badd +10 ~\Desktop\SOL1_MiniComputer\systemverilog\ide\testbench.sv
argglobal
%argdel
$argadd ide.sv
edit ~\Desktop\SOL1_MiniComputer\systemverilog\ide\testbench.sv
...
argglobal
balt ~\Desktop\SOL1_MiniComputer\systemverilog\ide\ide.sv
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists(fnamemodify("~\Desktop\SOL1_MiniComputer\systemverilog\ide\ide.sv", ":p")) | buffer ~\Desktop\SOL1_MiniComputer\systemverilog\ide\ide.sv | else | edit ~\Desktop\SOL1_MiniComputer\systemverilog\ide\ide.sv | endif
balt ~\Desktop\SOL1_MiniComputer\systemverilog\ide\testbench.sv
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
silent! normal! zE
let &fdl = &fdl
let s:l = 46 - ((23 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 46
