...
badd +1 Desktop\SOL1_MiniComputer\modelsim\systemverilog\pa_microcode.sv
...
silent! normal! zE
let &fdl = &fdl
let s:l = 114 - ((7 * winheight(0) + 12) / 24)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 94 - ((18 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 94
...
silent! normal! zE
let &fdl = &fdl
let s:l = 50 - ((9 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 50
...
argglobal
balt Desktop\SOL1_MiniComputer\modelsim\systemverilog\pa_microcode.sv
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
silent! normal! zE
let &fdl = &fdl
let s:l = 33 - ((7 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 33
