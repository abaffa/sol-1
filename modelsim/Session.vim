...
silent! normal! zE
let &fdl = &fdl
let s:l = 340 - ((17 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 340
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 123 + 118) / 237)
exe 'vert 2resize ' . ((&columns * 111 + 118) / 237)
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 155 - ((24 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 155
...
silent! normal! zE
let &fdl = &fdl
let s:l = 143 - ((28 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 143
...
silent! normal! zE
let &fdl = &fdl
let s:l = 143 - ((31 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 143
