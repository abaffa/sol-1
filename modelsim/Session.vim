...
badd +51 Desktop\SOL1_MiniComputer\modelsim\systemverilog\pa_microcode.sv
...
badd +0 Desktop\SOL1_MiniComputer\modelsim\systemverilog\ram.sv
badd +0 Desktop\SOL1_MiniComputer\modelsim\systemverilog\pa_cpu.sv
argglobal
%argdel
set stal=2
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 122 + 118) / 237)
exe 'vert 2resize ' . ((&columns * 112 + 118) / 237)
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 88 - ((10 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 88
...
silent! normal! zE
let &fdl = &fdl
let s:l = 61 - ((0 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 61
...
silent! normal! zE
let &fdl = &fdl
let s:l = 61 - ((18 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 61
